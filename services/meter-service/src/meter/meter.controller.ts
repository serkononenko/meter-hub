...
export class MeterController {
    ...
    @Post()
    async create(@Body() body: unknown): Promise<MeterDto> {
    ...
    @Get()
    async list(@Query('householdId') householdId: string | undefined): Promise<MeterDto[]> {
    ...
    @Get(':meterId')
    async get(@Param('meterId') meterId: string): Promise<MeterDto> {
    ...
    async update(@Param('meterId') meterId: string, @Body() body: unknown): Promise<MeterDto> {
        const id = parseUuidParam(meterId, 'meterId');
