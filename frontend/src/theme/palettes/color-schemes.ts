...
/**
 * Light/dark palette system ported from the Devias Kit. Neutral shades are
 * exposed as `palette.neutral.*` CSS variables that layout components
 * (side nav, tables) reference directly.
 */
export const colorSchemes: {light: ColorSystemOptions; dark: ColorSystemOptions} = {
  light: {
    palette: {
