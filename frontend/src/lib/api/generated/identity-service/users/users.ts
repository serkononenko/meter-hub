...
/**
 * Returns stable identity information about the user that owns the presented access token. Requires a valid Bearer access token.
 * @summary Return the authenticated user's identity
 */
export const getCurrentUser = async ( options?: Parameters<typeof orvalInstance>[1]): Promise<getCurrentUserResponse> => {

  return orvalInstance<getCurrentUserResponse>(getGetCurrentUserUrl(),
  {
    ...options,
    method: 'GET'
...
export const getGetCurrentUserQueryOptions = <TData = Awaited<ReturnType<typeof getCurrentUser>>, TError = Problem>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getCurrentUser>>, TError, TData>>, request?: SecondParameter<typeof orvalInstance>}
) => {
...
export function useGetCurrentUser<TData = Awaited<ReturnType<typeof getCurrentUser>>, TError = Problem>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getCurrentUser>>, TError, TData>>, request?: SecondParameter<typeof orvalInstance>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Return the authenticated user's identity
